...
<Error error={error}/>
<form method="post">
    <textarea row="15" bind:value={content}></textarea>
...
<div class="container my-3">
    ...
    <div class="card my-3">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                ...
                <div class="badge bg-light text-dark p-2 text-start">
                    <div class="mb-2">modified at</div>
                    <div>{moment(answer.create_date).format("YYYY-MM-DD hh:mm a")}</div>
                </div>
                {/if}
                <div class="badge bg-light text-dark p-2 text-start">
    ...
    <form method="post" class="my-3">
        ...
        <input type="submit" value="답변등록" 
            class="btn btn-primary{$is_login ? '' : 'disabled'}" on:click="{post_answer}" />
    </form>
</div>
